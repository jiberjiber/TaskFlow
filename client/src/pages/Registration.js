...
const Registration = () => {
	...
	const onRadioChange = (e) => {
		...
		if (e.target.value === false) {
			alert(
				"Please contact your project manager to receive your login credentials and create your employee account."
			);
		}
	};
	...
	return (
		<Container>
			<Card styles={{ marginLeft: 100 }}>
				<CardContent>
						<Typography variant="h1">Welcome to TaskFlow!</Typography>
						<Typography>
							Get started with smoother project management by providing your
							details below.
						</Typography>
